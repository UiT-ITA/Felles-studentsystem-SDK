...
{
    public partial class QueryTekstkategorierConnection
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("edges")]
        #endif
        [System.Text.Json.Serialization.JsonPropertyName("edges")]
        public ICollection<QueryTekstkategorierConnectionEdge> Edges { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        ...
        public ICollection<Tekstkategori> Nodes { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
