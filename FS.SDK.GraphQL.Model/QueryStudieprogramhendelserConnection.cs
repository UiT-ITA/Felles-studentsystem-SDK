...
{
    public partial class QueryStudieprogramhendelserConnection
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("edges")]
        #endif
        [System.Text.Json.Serialization.JsonPropertyName("edges")]
        public ICollection<QueryStudieprogramhendelserConnectionEdge> Edges { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        ...
        public ICollection<IStudieprogramhendelse> Nodes { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
