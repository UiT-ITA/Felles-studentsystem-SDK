...
{
    [GraphQlObjectType("Klasserolle")]
    public partial class Klasserolle : INode, IPersonrolle
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("id")]
        #endif
        ...
        public KlasserolleGyldighetsperiode Gyldighetsperiode { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        ...
        //IDatoperiode IPersonrolle.Gyldighetsperiode { get => Gyldighetsperiode; set => throw new NotSupportedException("Use \"Klasserolle.Gyldighetsperiode\" property setter"); }
    }
}
