...
{
    public partial class OpprettKlasserForKullPayload
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("klasser")]
        #endif
        [System.Text.Json.Serialization.JsonPropertyName("klasser")]
        public ICollection<Klasse> Klasser { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("errors")]
        [JsonConverter(typeof(GraphQlInterfaceJsonConverter))]
        #endif
        [System.Text.Json.Serialization.JsonPropertyName("errors")]
        public ICollection<IOpprettKlasserForKullError> Errors { get; set; }
    }
}
