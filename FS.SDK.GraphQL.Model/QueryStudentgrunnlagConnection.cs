...
{
    public partial class QueryStudentgrunnlagConnection
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("edges")]
        #endif
        [System.Text.Json.Serialization.JsonPropertyName("edges")]
        public ICollection<QueryStudentgrunnlagConnectionEdge> Edges { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        ...
        public ICollection<Studentgrunnlag> Nodes { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
