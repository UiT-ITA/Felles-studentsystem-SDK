...
{
    [GraphQlObjectType("EvuKursrolle")]
    public partial class EvuKursrolle : INode, IPersonrolle
    {
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        [JsonProperty("id")]
        #endif
        ...
        public KursrolleGyldighetsperiode Gyldighetsperiode { get; set; }
        #if !GRAPHQL_GENERATOR_DISABLE_NEWTONSOFT_JSON
        ...
        //IDatoperiode IPersonrolle.Gyldighetsperiode { get => Gyldighetsperiode; set => throw new NotSupportedException("Use \"EvuKursrolle.Gyldighetsperiode\" property setter"); }
    }
}
